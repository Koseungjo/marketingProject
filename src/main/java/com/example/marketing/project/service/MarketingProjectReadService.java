...
public class MarketingProjectReadService {
    ...
    public MarketingProjectResponseList getMarketingProjectList(MarketingProjectSearchRequest request, Pageable pageable) {
        ...
        MarketingProjectResponseList responseList = MarketingProjectResponseList.of(responses);
        return responseList;
    }

    public MarketingProjectDetailResponse getMarketingProjectDetail(Long projectId) {
